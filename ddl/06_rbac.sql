...
-- FW_EXECUTOR can auto-create and use external stages for GCS ingestion
GRANT CREATE STAGE ON SCHEMA INGESTION_FW.UTIL TO ROLE FW_EXECUTOR;
GRANT USAGE ON INTEGRATION GCS_INGESTION_INT   TO ROLE FW_EXECUTOR;
